...
file_param = os.path.join(DIR_INPUT, "Nicholl_Magnetar_FlatV2.dat")
...
def main():
    ...
    parser.add_argument('-z', '--redshift', nargs=2, type=float, default=[0.06, 0.2],
                        help="Redshift Range, [Default = [0.06, 0.2]")
